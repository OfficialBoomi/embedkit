...
const cssVarOptions = [
  ...
  '--boomi-agent-composer-backdrop-bg',
  ...
  // SweetAlert (confirm/alert dialogs)
  '--boomi-swal-bg',
  '--boomi-swal-fg',
  '--boomi-swal-border',
  '--boomi-swal-shadow',
  ...
  // Toast notifications
  '--boomi-toast-success-bg',
  '--boomi-toast-success-fg',
  '--boomi-toast-success-icon',
  '--boomi-toast-error-bg',
  '--boomi-toast-error-fg',
  '--boomi-toast-error-icon',
  '--boomi-toast-warning-bg',
  '--boomi-toast-warning-fg',
  '--boomi-toast-warning-icon',
  '--boomi-toast-info-bg',
  '--boomi-toast-info-fg',
  '--boomi-toast-info-icon',
  '--boomi-toast-question-bg',
  '--boomi-toast-question-fg',
  '--boomi-toast-question-icon',
  '--boomi-toast-position',
  '--boomi-toast-timer',
  '--boomi-toast-width',
  '--boomi-toast-radius',
  '--boomi-toast-shadow',
